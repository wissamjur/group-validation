...
def flip_pofile_ratings(ratings_detailed, movies, target_clusters, N, users_thresh):
    # make a copy of the original ratings df
    modified_ratings = ratings_detailed.copy()
    records_to_add = []

    # threshold to consider for "+ve" feedback (rating >= like_threh is considered +ve)
    like_threh = 3
...
def add_random_ratings(ratings, clusters, target_clusters, N, users_thresh):
    # make a copy of the original ratings df
